...
namespace Ent.Sql.ClinicaE.PresotorE
{
    public class PresotorE
    {
        ...
        public PresotorE(string pCodPresotor, string pBuscar, string pCampo, int pNumeroFilas, int pOrdern)
        {
            CodPresotor = pCodPresotor;
            Buscar = pBuscar;
            Campo = pCampo;
        ...
        public PresotorE(string pCodAtencion, string pCodPrestacion, int pCodUser)
        {
            CodAtencion = pCodAtencion;
        ...
        public PresotorE(string pCampo, string pCodPresotor, string pNuevoValor)
        {
            Campo = pCampo;
            CodPresotor = pCodPresotor;
