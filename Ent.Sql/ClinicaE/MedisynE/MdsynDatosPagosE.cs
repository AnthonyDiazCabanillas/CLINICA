...
namespace Ent.Sql.ClinicaE.MedisynE
{
    public class MdsynDatosPagosE
    {
        ...
        private DateTime _FecNacimiento = new DateTime(1900, 01, 01);
        ...
        private DateTime _FecIniciovigencia = new DateTime(1900, 01, 01);
        public DateTime FecIniciovigencia
        {
            get
            {
        ...
        private DateTime _FecAfilicacion = new DateTime(1900, 01, 01);
        public DateTime FecAfilicacion
        {
            get
            {
        ...
        private DateTime _FecCita = new DateTime(1900, 01, 01);
        public DateTime FecCita
        {
            get
            {
                return _FecCita;
