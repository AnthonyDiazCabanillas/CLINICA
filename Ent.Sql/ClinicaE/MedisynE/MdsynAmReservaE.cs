...
namespace Ent.Sql.ClinicaE.MedisynE
{
    public class MdsynAmReservaE
    {
        ...
        public string DscPago { get; set; } = "";

        // I.GLLUNCOR - 11/03/2022 - Se está agregando para guardar el nombre y fecha de envio del código QR de estacionamiento.
        public string DscNombreQR { get; set; } = "";
        public string FlgEnvioQREstacionamiento { get; set; } = "";
        public int UsrEnvioQREstacionamiento { get; set; }
        public DateTime FecEnvioQREstacionamiento { get; set; }
        // F-GLLUNCOR - 11/03/2022

        // I.GLLUNCOR - 11/03/2022 - Se está agregando para obtener el código QR de estacionamiento
        public string DscQr { get; set; } = "";
        public string DscPathQr { get; set; } = "";
        // F-GLLUNCOR - 11/03/2022
        ...
        {
            IDCita = int.Parse( pIdeReserva.ToString());  // JRRA 1.1
            IdeReserva = pIdeReserva;
            NuevoValor = pNuevoValor;
            Campo = pCampo;
        ...
        public MdsynAmReservaE(long pIdeReserva, int pIdeCorrelReserva, string pFecInicio, string pFecFin, string pCodSede
            , string pNombresPaciente, string pRutPaciente, string pCodPaciente, string pOrden)
        {
            IdeReserva = pIdeReserva;
            IdeCorrelReserva = pIdeCorrelReserva;
