...
namespace Ent.Sql.ClinicaE.ComprobantesE
{
    public class ComprobantesElectronicosE
    {
        ...
        public int EstadoRegistro { get; set; } = 0;
        ...
        public string FechaRegistroRpta { get; set; } = "";
        ...
        public string TipoComprobanteSunat { get; set; } = "";
        public string TipoComprobanteCSF { get; set; } = "";
        public string CodComprobanteEle { get; set; } = "";
        public string FechaCdrSis { get; set; } = "";
        public string FechaCdrSunat { get; set; } = "";
        public string ObservacionCdr { get; set; } = "";
        public string FechaConfirmaSis { get; set; } = "";
        public string ObservacionConfirma { get; set; } = "";
        public string FechaOtorgamientoSis { get; set; } = "";
        ...
        public string FecEnviobajasap { get; set; } = "";
        ...
        public ComprobantesElectronicosE(string pCodcomprobante, int pOrden)
        {
            Codcomprobante = pCodcomprobante;
            Orden = pOrden;
        }
