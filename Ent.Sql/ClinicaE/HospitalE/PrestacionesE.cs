...
namespace Ent.Sql.ClinicaE.HospitalE
{
    public class PrestacionesE
    {
        ...
        public int Key { get; set; } = 25;
        public string Filtro { get; set; } = "";

        #region CONSTRUCTORES
        public PrestacionesE() { }
        ...
        public PrestacionesE(int pOrden, string? pCodatencion, string? pCodprestacion, string? pCodtarifa, string? pDscprestacion, int pNroFilas)
        {
            Orden = pOrden;
