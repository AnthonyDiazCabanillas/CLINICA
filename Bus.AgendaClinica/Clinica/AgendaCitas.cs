...
//    1.1               25/07/2024     HVIDAL       REQ 2024-011473 AGENDA DE PROCEDIMIENTOS
//****************************************************************************************
using System;
...
namespace Bus.AgendaClinica.Clinica
{
    public class AgendaCitas
    {
        ...
        {
            var oCitaAgendaAD = new CitaAgendaAD();
            var oData = oCitaAgendaAD.Sp_Cita_ListarQR(pCitaAgendaE);

            return oData;
        }

        //INI - HVIDAL 27/02/2024
        public RceValidaHojaRutaE.Body ObtenerHojaDeRutaByte(RceValidaHojaRutaE.SoftVan pSoftVan, int ide_historia)
        {
            //INI 1.1
            int valorUser = Convert.ToInt32(new AgendaCitas().pValorCodigoTabla("REPORTE_AGENDA_ACCESO", "01"));
            string valorDato = new AgendaCitas().pValorCodigoTabla("REPORTE_AGENDA_ACCESO", "02");
            //FIN 1.1
            var pBody = new RceValidaHojaRutaE.Body();
            pBody.ide_log_consulta = 0;
            //INI 1.1
            pBody.ide_usuario = valorUser;
            pBody.dsc_login = valorDato;
            //FIN 1.1
            pBody.dsc_archivo_rpt = "RpHojaDeRuta.rpt";
            pBody.tip_reporte = "pdf";
            pBody.dsc_parametros_valores = null;

            var LParametro = new List<RceValidaHojaRutaE.Parametros>();
            var pParametro = new RceValidaHojaRutaE.Parametros();
            pParametro.Dsc_Parametro = "@ide_historia";
            pParametro.Valor_Parametro = ide_historia.ToString();
            pParametro.Dsc_archivo_rpt = "";
            LParametro.Add(pParametro);

            pParametro = new RceValidaHojaRutaE.Parametros();
            pParametro.Dsc_Parametro = "@orden";
            pParametro.Valor_Parametro = "1";
            pParametro.Dsc_archivo_rpt = "";
            LParametro.Add(pParametro);

            pParametro = new RceValidaHojaRutaE.Parametros();
            pParametro.Dsc_Parametro = "@orden";
            pParametro.Valor_Parametro = "2";
            pParametro.Dsc_archivo_rpt = "RpHojaDeRutaLaboratorio.rpt";
            LParametro.Add(pParametro);

            pParametro = new RceValidaHojaRutaE.Parametros();
            pParametro.Dsc_Parametro = "@cod_atencion";
            pParametro.Valor_Parametro = pSoftVan.cod_atencion;
            pParametro.Dsc_archivo_rpt = "RpHojaDeRutaProcedimientoMedRzdo.rpt";
            LParametro.Add(pParametro);

            pParametro = new RceValidaHojaRutaE.Parametros();
            pParametro.Dsc_Parametro = "@cod_atencion";
            pParametro.Valor_Parametro = pSoftVan.cod_atencion;
            pParametro.Dsc_archivo_rpt = "RpHojaDeRutaProcedimientoMedStdo.rpt";
            LParametro.Add(pParametro);
            pBody.Parametros = LParametro;

            var pInforme = new RceValidaHojaRutaE.rptInformesMaeE();
            pInforme.ide_informe = 1;

            pBody.rptInformesMaeE = pInforme;

            pBody.dsc_sistema = "AGENDA APP/WEB";
            pBody.cod_atencion = pSoftVan.cod_atencion;
            pBody.chkfarmacologicot = true;
            pBody.chknofarmacologicop = true;

            return pBody;
        }
        //FIN - HVIDAL 27/02/2024

        //INI - HVIDAL 27/02/2024
        public RceValidaHojaRutaE.Body ObtenerRecetaByte(RceValidaHojaRutaE.SoftVan pSoftVan, int ide_historia)
        {
            //INI 1.1
            int valorUser = Convert.ToInt32(new AgendaCitas().pValorCodigoTabla("REPORTE_AGENDA_ACCESO", "01"));
            string valorDato = new AgendaCitas().pValorCodigoTabla("REPORTE_AGENDA_ACCESO", "02");
            ...
            pBody.dsc_login = valorDato;
            //FIN 1.1
            pBody.dsc_archivo_rpt = "RpRecetaAlta.rpt";
            pBody.tip_reporte = "pdf";
            pBody.dsc_parametros_valores = null;
            ...
            pParametro = new RceValidaHojaRutaE.Parametros();
            pParametro.Dsc_Parametro = "@ide_receta";
            pParametro.Valor_Parametro = "0";
            pParametro.Dsc_archivo_rpt = "";
            LParametro.Add(pParametro);

            pParametro = new RceValidaHojaRutaE.Parametros();
            pParametro.Dsc_Parametro = "@orden";
            pParametro.Valor_Parametro = "4";
            pParametro.Dsc_archivo_rpt = "";
            LParametro.Add(pParametro);

            //<I> - MBARDALES - 08/05/2024
            pParametro = new RceValidaHojaRutaE.Parametros();
            pParametro.Dsc_Parametro = "@codmedico";
            pParametro.Valor_Parametro = "00000590"; //éste valor no se tomará en cuenta
            pParametro.Dsc_archivo_rpt = "";
            LParametro.Add(pParametro);
            //<F> - MBARDALES - 08/05/2024

            pParametro = new RceValidaHojaRutaE.Parametros();
            pParametro.Dsc_Parametro = "@codigo";
            pParametro.Valor_Parametro = pSoftVan.cod_atencion;
            pParametro.Dsc_archivo_rpt = "RpRecetaAltaDiag.rpt";
            LParametro.Add(pParametro);

            pParametro = new RceValidaHojaRutaE.Parametros();
            pParametro.Dsc_Parametro = "@tipo";
            pParametro.Valor_Parametro = "S";
            pParametro.Dsc_archivo_rpt = "RpRecetaAltaDiag.rpt";
            LParametro.Add(pParametro);

            pParametro = new RceValidaHojaRutaE.Parametros();
            pParametro.Dsc_Parametro = "@coddiagnostico";
            pParametro.Valor_Parametro = "";
            pParametro.Dsc_archivo_rpt = "RpRecetaAltaDiag.rpt";
            LParametro.Add(pParametro);
        ...
        //INI - HVIDAL 27/02/2024
        public string pValorCodigoTabla(string tabla, string codigo)
        {
            string resultado = "";
            List<TablasE> oList;
        ...
        //INI 1.0 HVIDAL
        public RceValidaHojaRutaE.Body ObtenerPQ(RceValidaHojaRutaE.SoftVan pSoftVan, int ID_PQ_Det)
        {
            //INI 1.1
            int valorUser = Convert.ToInt32(new AgendaCitas().pValorCodigoTabla("REPORTE_AGENDA_ACCESO", "01"));
            string valorDato = new AgendaCitas().pValorCodigoTabla("REPORTE_AGENDA_ACCESO", "02");
            ...
            pBody.ide_log_consulta = 0;
            //INI 1.1
            //pBody.ide_usuario = 3475;
            //pBody.dsc_login = "AMADO QUIROZ";
            pBody.ide_usuario = valorUser;
            pBody.dsc_login = valorDato;
            //FIN 1.1
            pBody.dsc_archivo_rpt = "RpProgramacionQuirurgica.rpt";
            pBody.tip_reporte = "pdf";
            pBody.dsc_parametros_valores = null;

            var LParametro = new List<RceValidaHojaRutaE.Parametros>();
            var pParametro = new RceValidaHojaRutaE.Parametros();
            pParametro.Dsc_Parametro = "@ID_PQ_Det";
            pParametro.Valor_Parametro = ID_PQ_Det.ToString();
            pParametro.Dsc_archivo_rpt = "";
            LParametro.Add(pParametro);
        ...
        {
            var oRceCptAD = new RceCptAD();
            var oData = oRceCptAD.Sp_Cpt_ListarDetalle();
        ...
        //FIN 1.0
        //INI 1.0
        public string pValorCodigoTablaImg(string tabla, string codigo)
        {
            string resultado = "";
            List<TablasE> oList;
            oList = new TablasAD().Sp_Tablas_Consulta(new TablasE(tabla, codigo, 1, 1, 11));
            if (oList.Count >= 1) resultado = oList[0].Nombre.Trim();
            return resultado;
        }
        //FIN 1.0
        ...
        public string DemoFechaOracle(int IdeCorrelreserva)
        {
            ...
            try
            {
                ...
                oMdsynDatosPagosE.FecCita = new DateTime(objAmReservaE.FecReserva.Year, objAmReservaE.FecReserva.Month, objAmReservaE.FecReserva.Day, objAmReservaE.HoraReserva.Hour, objAmReservaE.HoraReserva.Second, 0);
            }
            catch (Exception ex)
            {
        ...
        public RespuestaE SetPagosApp(string CodAsegurado, string TipDocumento, string NumDocumento, string TipPrt, string TipParentesco, string NroPlan, string TipDocempresa, string NumDocempresa, DateTime FecNacimiento, DateTime FecIniciovigencia, DateTime FecAfilicacion, string CodCobertura, decimal CoPagofijo, decimal CoPagovariable, string TipMoneda, int IdeCorrelreserva, string TipAtencion, string CodPaciente, string CodPacienteTitular, string CodIAFAS, string CodSede, string CodProfMedico, DateTime FecCita, string NroOperacion, string DscMensajeRespuesta, string EstPagoExitoso, string TipoTarjeta, string NumeroTarjeta, string Comp_TipoComprobante = "B", string Comp_TipDocIdentidad = "0", string Comp_Rut_DocIdentidad = "", string Comp_DscTabla = "P", string Comp_Correo = "", string TipoEnvio = "", string ResponsableEnvio = "", string TipoConsultaMedica = "A", string TransactionIdNiubiz = "", string Version = "V2")
        {
            ...
            try
            {
                ...
                oMdsynDatosPagosE.FecNacimiento = FecNacimiento;
                oMdsynDatosPagosE.FecIniciovigencia = FecIniciovigencia;
                oMdsynDatosPagosE.FecAfilicacion = FecAfilicacion;
        ...
        public string fnCitaPagado(int pIdeCorrelReserva)
        {
            ...
            try
            {
                ...
                oList = new MdsynAmReservaAD().Sp_Mdsyn_Cita_Consulta(new MdsynAmReservaE(0, pIdeCorrelReserva, "", "", "", "", "", "", 10.ToString()));
            ...
            try
            {
                ...
                else
                {
                    ...
                    using (var oWsTisal = new ServicioReservaHoraWebSoapClient(VariablesGlobales.Binding, VariablesGlobales.EndPoint))
                    {
                        ...
                        new MdsynAmReservaAD().Sp_Mdsyn_Cita_Update(new MdsynAmReservaE(0, mvarIDReserva, "", "", "", "", "", "", DateTime.Now, "", 0, "", "update_reserva_anulada", 4, "S"));
        ...
        public string WM_BuscaCargas(int Cod_Empresa, int Id_GrupoFamiliar)
        {
            ...
            try
            {
                ...
                for (int i = 0; i <= dtReservaHora.Rows.Count - 1; i++)
                {
                    ...
                    stringXML = stringXML + "<ENCRYPTED_ID>" + Utilities.Criptography.EncryptConectionString(util.Rigth("0000" + Rut_Paciente, 8)) + "</ENCRYPTED_ID>";
