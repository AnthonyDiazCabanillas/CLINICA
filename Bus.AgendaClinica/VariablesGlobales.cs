...
using static Bus.AgendaClinica.Clinica.AgendaCitas.Response_XML.XML;
...
namespace Bus.AgendaClinica.Clinica
{
    public static class VariablesGlobales
    {
        ...
        {
            string StringConection = pNameConectionString;

            if (ConfigurationManager.ConnectionStrings[pNameConectionString] != null)
        ...
        public static void Guardar_Error_BaseDatos(string pMensaje, string pMetodo)
        {
            if (ActivarLogGuardar == true)
            {
                ...
                new CorreoAgenda().GuardarMensajeNotepad(pMensaje, pMetodo);
            }
        }
        ...
        public static string UserRedQR { get; set; } = "";
        public static string ClaveRedQR { get; set; } = "";
