setTimeout(async function () {
    ...
    const webSocketUrls = 'wss://localhost:19916/Web.Clinica/,ws://localhost:19917/Web.Clinica/'.split(',');
    const sharedSecret = await getSecret('');
    let connection;
